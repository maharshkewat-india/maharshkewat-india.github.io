    ...
    >
      ...
      <div className="mt-5 flex flex-wrap gap-2">
        {project.technologies.map((item) => (
          <span key={item} className="rounded-md border border-white/10 bg-black/20 px-2.5 py-1 text-xs text-slate-300 transition hover:border-cyan-300/30 hover:text-cyan-200">
            {item}
          </span>
        ))}
      </div>
      <div className="mt-auto flex flex-wrap gap-4 pt-7 text-sm font-semibold">
        <Link
          ...
          className="text-cyan-200 transition hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-300"
        >
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="text-slate-300 transition hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-300"
        >
