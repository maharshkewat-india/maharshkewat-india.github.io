      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 grid gap-4 md:grid-cols-2">
          {simulations.map((simulation) => {
            const isExpanded = expandedExperience === simulation.title;

            return <motion.article layout={!reduceMotion} key={simulation.title} className="flex flex-col rounded-xl border border-white/10 bg-[#091018]/60 p-5 sm:p-6">
